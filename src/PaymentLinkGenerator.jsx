...
const fetchProductDataTotal = async (id) => {
  try {
    const response = await fetch(`https://servidor-invetariovending.onrender.com/api/inventario-total/${id}`);
...
const fetchLoteData = async (lote) => {
  try {
    const response = await fetch(`https://servidor-invetariovending.onrender.com/api/inventario-total/lote/${lote}`);
...
const handleSaveProduct = async (paymentLink) => {
  try {
    ...
    const response = await fetch("https://servidor-invetariovending.onrender.com/api/inventario-vending", {
      method: "POST",
...
const updateInventoryQuantity = async (productId, quantityToDeduct) => {
  try {
    ...
    const response = await fetch(`https://servidor-invetariovending.onrender.com/api/inventario-total/${productId}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  const handleAddInventory = async () => {
    ...
    try {
      const response = await fetch("https://servidor-invetariovending.onrender.com/api/inventario-total", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
